...
Simple first. Useful first. Scalable later.
# Velox MVP Structure-Only Build Prompt

Use this prompt when you want Codex to create only the first Velox app folder and file structure without building real application logic yet.

Prompt:

Codex, create the initial velox-app file structure based on VELOX_MVP_APP_STRUCTURE.md.

Follow the approved direction:

- The working application folder is named velox-app.
- The foundation repository is velox-technical-foundation.
- Keep the build simple.
- Do not implement full app logic yet.
...
Create only the initial MVP file and folder structure needed for:
...
After creating the structure, report:

1. What folders were created
2. What files were created
3. What was intentionally not built yet
4. Whether the structure is ready for the next MVP build step
